...
void multiply_by_10(s21_decimal *value) {
    ...
    // Реализуйте умножение temp на 10 и сохраните в result
    // Простая арифметика с учетом переполнения (нужно реализовать)
...
int main(){
    ...
    s21_decimal b = {{0x00000002, 0x00000000, 0x00000000, 0x00000000}};
    s21_decimal res;
    printf("%d\n", s21_mul(a, b, &res)); 
