...
int auxiliary_mul(s21_decimal value_1, s21_decimal value_2, s21_decimal *result){
    ...
    if(res_scale<0){
        ...
        *result = s21_decimal_get_inf();
        ...
        if(res_scale > 28){
            ...
            while(temp_scale > 28){
                temp = double_decimal_binary_division(temp,create_double_decimal_from_decimal(s21_decimal_get_ten()),NULL);
                temp_scale--;
            }
    ...
    if(!result || !is_correct_decimal(value_1) || !is_correct_decimal(value_2)){
        ...
        *result = create_zero_decimal();
        ...
        if(sign_1 == 0 && sign_2 == 0){
            ...
            status = auxiliary_mul(s21_decimal_abs(value_1),s21_decimal_abs(value_2),&res);
        }
