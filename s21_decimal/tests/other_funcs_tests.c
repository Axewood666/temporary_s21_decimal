...
START_TEST(test_truncate_4) {
  s21_decimal number_decimal = {
      {0x4D6C8050, 0x0003F28F, 0x00000000, 0x000b0000}};
  ck_assert_int_eq(s21_truncate(number_decimal, NULL), 1);
}
END_TEST
...
START_TEST(test_negate_3) {
  s21_decimal decimal = {{0x00000020, 0x00000000, 0x00000000, 0x80000000}};
  ck_assert_int_eq(s21_negate(decimal, NULL), 1);
}
END_TEST
...
START_TEST(test_floor_4) {
  s21_decimal number_decimal = {
      {0x4D6C8050, 0x0003F28F, 0x00000000, 0x000b0000}};
  ck_assert_int_eq(s21_floor(number_decimal, NULL), 1);
}
END_TEST
...
START_TEST(test_round_4) {
  s21_decimal number_decimal = {
      {0x4D6C8050, 0x0003F28F, 0x00000000, 0x000b0000}};
  ck_assert_int_eq(s21_round(number_decimal, NULL), 1);
}
END_TEST
